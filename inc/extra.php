                ...
                <div class="footer-credits-text text-center">
                    <div>
                        <?php
                            ...
                            printf('Copyright © qsdrqs ' . $year);
                        ?>
                    </div>
                    <?php
                    /* translators: %s: WordPress string with wordpress.org URL */
                    printf(esc_html__('Based on %s', 'popularis'), '<a href="' . esc_url(__('https://wordpress.org/', 'popularis')) . '">WordPress</a>');
                    ?>
                    <span class="sep"> | </span>
                    <?php
                    /* translators: %1$s: Popularis theme name with populariswp.com URL */
                    printf(esc_html__('Modified from: %1$s', 'popularis'), '<a href="' . esc_url('https://populariswp.com/') . '">' . 'Popularis</a>');
                    ?>
                </div>
            </div>	
        </footer>
